    ...
    <a class="btn btn-primary" href="<?php echo base_url('datos/Datos')?>">Volver</a></p>
    ...
    <div class="col-md-4 col-md-offset-4">
            <a class="btn btn-primary btn-block" href="<?php echo base_url('datos/Datos/buscar')?>">Arriba</a>
        </div>
    </div>
