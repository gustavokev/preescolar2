...
<section class="bg-info main row">
	...
	<a class="btn btn-success" href="<?php echo base_url('alumnos/Alumnos/registrar') ?>" title="">Registrar Alumnos</a></p>
		...
		<tr class="">
			...
			<td class="active"><a class="btn bg-warning" href="<?php echo base_url('alumnosAlumnos/detalles/'.$alumnos->id) ?>">Detalles</a></td>
			<td class="active"><a class="btn bg-warning" href="<?php echo base_url('alumnosAlumnos/modificar/'.$alumnos->id) ?>">Editar</a></td>
